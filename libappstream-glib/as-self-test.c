...
as_test_release_appstream_func (void)
{
	...
	const gchar *src =
		...
		"<checksum filename=\"firmware.cab\" type=\"sha1\">12345</checksum>\n"
		"<checksum filename=\"firmware.cab\" type=\"md5\">deadbeef</checksum>\n"
...
as_test_checksum_func (void)
{
	...
	GNode *root;
	GString *xml;
	const gchar *src = "<checksum filename=\"fn.cab\" type=\"sha1\">12345</checksum>";
	gboolean ret;
	_cleanup_free_ AsNodeContext *ctx = NULL;
