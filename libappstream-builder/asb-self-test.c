...
asb_test_context_test_func (AsbTestContextMode mode)
{
	...
	expected_xml =
		...
		"<checksum filename=\"colorhug-als-2.0.2.cab\" type=\"sha1\">522aeefdcc7f27658d73de76107fe62550c61868</checksum>\n"
		"<checksum filename=\"firmware.bin\" type=\"sha1\">767a8a7b8a7b350b513f57761204b4aaa657aa44</checksum>\n"
...
asb_test_firmware_func (void)
{
	...
	expected_xml =
		...
		"<checksum filename=\"colorhug-als-2.0.1.cab\" type=\"sha1\">c7cc46d54d8d4ba452b677a2367214efbaa40fd5</checksum>\n"
		"<checksum filename=\"firmware.bin\" type=\"sha1\">767a8a7b8a7b350b513f57761204b4aaa657aa44</checksum>\n"
		"<description><p>This unstable release adds the following features:</p>"
		...
		"<checksum filename=\"colorhug-als-2.0.0.cab\" type=\"sha1\">186ad37fe3e63acc843b8727ac1add4ac15f0bf8</checksum>\n"
		"<checksum filename=\"firmware.bin\" type=\"sha1\">767a8a7b8a7b350b513f57761204b4aaa657aa44</checksum>\n"
		"</release>\n"
		"</releases>\n"
		"</component>\n"
